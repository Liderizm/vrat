...
.setColor('#ffffff') 
.setAuthor(`Cool Medya Moderasyon Komutları`, client.user.avatarURL())
.setDescription(`<:a_:821738957997211659>  Cool Medya botumuzu eklemek için \`${prefix}davet\` yazabilirsiniz.`)
